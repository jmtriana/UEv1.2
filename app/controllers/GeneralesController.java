...
public class GeneralesController extends Controller {
    ...
    public String [] header_acc = new String[6];
    public String linea = "";
    ...
    public Result tabla() {
            ...
            if(linea.equals("acceso")){
                System.out.println("Ingreso tabla acceso");
                ArrayList<Item> d = new ArrayList<>();
                ArrayList<Item> SelectedAcceso = new ArrayList<>();
                Acceso acceso = Acceso.getInstance();

                for(int l=0; l<header_acc.length;l++){
                    d = acceso.retornaAcc(header_acc[l].toString());
                    SelectedAcceso.addAll(d);
                }
                Item res3[] = arrayListToArray(SelectedAcceso);
                return ok(views.html.table.render(res3,indic));
            }
...
//=============================================== CAPTURA VARIABLES ========================================
            ...
            //Tabla Acceso
            String ac = formGeneral.field("ac").value();
            String ac1 = formGeneral.field("ac1").value();
            String ac2 = formGeneral.field("ac2").value();
            String ac3 = formGeneral.field("ac3").value();
            String ac4 = formGeneral.field("ac4").value();
            String ac5 = formGeneral.field("ac5").value();
            String [] headeracc = new String[6];
            headeracc[0] = ac;
            headeracc[1] = ac1;
            headeracc[2] = ac2;
            headeracc[3] = ac3;
            headeracc[4] = ac4;
            headeracc[5] = ac5;
            header_acc = RemoveNull(headeracc);
            System.out.println(Arrays.toString(header_acc));
...
// FIN INDICADORES
    ...
    public Result seeActivities(){
        ...
        Historico[] linea_ac = listToArrayh(Historico.finderHistorico.where().like("linea","acceso").findList());
        ...
        return ok(views.html.resumen.render(array,datos_wl,total_reg,total_wl,general,linea_wl,linea_mw,linea_dw,linea_ac,sitios_ok));
    }
