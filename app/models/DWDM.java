...
public class DWDM extends Model{
    ...
    public DWDM(){
        ...
        Item item20dw = new Item(" La fibra optica debe ser amarrada con velcro.",0.5,"","dwdm","5.1.009");
        ...
        Item item28dw = new Item("La canaleta debe ser instalada adecuadamente con los accesorios necesarios garantizando la fijacion de la misma.Debe quedar a nivel y aterrizada al barraje del sitio.",1,"","dwdm","10.0.002");
