...
public class Microondas extends Model{
    ...
    public Microondas(){
        ...
        Item item4mw = new Item("La configuracion de la RTN es realizada correctamente y deacuerdo a los requerimienos de diseño. La marquilla debe ser laminada y sujeta a los tornillos del anclaje del radio con la información correcta.",0.5,"","Microondas","2.1.016");
        ...
        Item item12mw = new Item(" La protección de tierra del cable de poder DC se debe conectar al barraje de tierra que nos provea el cliente o dejarlo en punta",4,"","Microondas","3.1.005");
